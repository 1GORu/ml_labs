...
7. **Hypothesis_testing_examples.ipynb** / Практические примеры проверки статистических гипотез (дополняется)
8. **own_tasks** / Собственные задачи, проекты и эксперименты
